        ...
        <div class="col-span-2 flex flex-col gap-6">
            ...
            <div class="bg-white border border-stone-200 rounded-2xl p-6 shadow-sm">
                <div class="flex items-center justify-between mb-5">
                    <p class="text-xs font-medium tracking-widest text-stone-400 uppercase">Réalisations récentes</p>
                ...
                @else
                    <div class="text-center py-10">
                        <p class="text-stone-400 text-sm mb-4">Aucun projet publié.</p>
            ...
            <div class="bg-white border border-stone-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-3 mb-5">
                    <div class="bg-stone-50 rounded-xl p-4 text-center">
                        <p class="font-serif text-2xl font-semibold text-green-800">{{ $profile->projects->count() }}</p>
                        <p class="text-xs text-stone-400 mt-1">Projets</p>
                    </div>
                    <div class="bg-stone-50 rounded-xl p-4 text-center">
                        <p class="font-serif text-2xl font-semibold text-green-800">{{ $profile->experience_years }}</p>
                        <p class="text-xs text-stone-400 mt-1">Ans exp.</p>
                    </div>
                    <div class="bg-stone-50 rounded-xl p-4 text-center">
                        <p class="font-serif text-2xl font-semibold text-green-800">{{ $profile->availabilities->count() }}</p>
